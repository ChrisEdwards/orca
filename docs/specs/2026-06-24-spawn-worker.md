...
- **orca-agent skill.** The thin conversational surface. The orchestrator invokes it with an agent type, a task, and an optional cwd, and it calls the bundled `scripts/orca-spawn`.
